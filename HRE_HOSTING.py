...
TOKEN = "8379220663:AAGTt4HMdPRzjoer-7Z3W26crmtOV7wZ_Bc"
OWNER_ID = int(os.getenv('OWNER_ID', 7486456672))
ADMIN_ID = int(os.getenv('ADMIN_ID', 8242194530))
YOUR_USERNAME = os.getenv("@dark_edits_999", "HRE_TERA_BAAPP")
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', '@hre_helps')
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        ...
        types.InlineKeyboardButton('📞 Contact Owner', url='https://t.me/hre_non_bot')
    ]
